...
class RiskyChainEnv:
    ...
    Costs:
      ...
      RISKY: mixture: with p_tail -> Pareto tail (very large), else N(0.10, 0.05^2)+
    """
    def __init__(self, p_tail=0.06, seed=None):
        self.rng = np.random.RandomState(seed)
        self.p_tail = p_tail
        self.state = 0  # start SAFE
